...
/**
 * JPA Entity representing a rule for identifying a layout based on file content or metadata.
 * Maps to the 'layout_identification_rule' table in Oracle database.
 * 
 ...
 * Multiple rules for the same layout are combined with AND logic.
 * 
 * Implements IdentificationRule interface to allow shared components (ValueExtractor, CriteriaComparator, etc.)
 * to work with both layout identification and customer identification rules.
 */
@Entity
...
@NoArgsConstructor
@AllArgsConstructor
public class LayoutIdentificationRule implements IdentificationRule {
